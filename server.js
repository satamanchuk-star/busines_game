...
const P = {
  ...
  catIds:  ['К1','К2','К3','К4'],
  catNames:['Базовая','Fresh','Промо-хиты','Импорт/премиум'],
...
const LBL = {R1:'Р1',R2:'Р2',R3:'Р3',S1:'П1',S2:'П2',S3:'П3',S4:'П4',D:'Д'};
const LBL2ID = {}; Object.entries(LBL).forEach(([k,v])=>{ LBL2ID[v]=k; });
function normTeam(t) {
  if(!t) return t;
...
const ROLE_SETS = {
  ret: [
    ...
    {ico:'📦',title:'Менеджер закупок',      duty:'Объёмы заказов поставщикам'},
